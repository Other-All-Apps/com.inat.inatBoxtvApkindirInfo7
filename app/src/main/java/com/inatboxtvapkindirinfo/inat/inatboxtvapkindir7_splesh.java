...
public class inatboxtvapkindir7_splesh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inatboxtvapkindir7_activity_splash);
        datafromlink();
        loadFullscreenad();
        NextScreen();
    ...
    private void NextScreen() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                inatboxtvapkindir7_splesh.this.startActivity(new Intent(inatboxtvapkindir7_splesh.this, inatboxtvapkindir7_start_page.class));
                finish();
            }
        },5000);
    }
...
///////////////////////////////////
        ...
        interstitialAd2 = new com.facebook.ads.InterstitialAd(this, getString(R.string.fbfull1));
        ...
        InterstitialAdListener interstitialAdListener1 = new InterstitialAdListener() {
            ...
            @Override
            public void onError(Ad ad, AdError adError) {
                Log.e(Splash, "fbfull 2 " + adError.getErrorMessage());
            }
    ...
    public static void inflateAd(NativeAd nativeAd, View adView, final Context context) {
        ...
        nativeAdMedia.setListener(new MediaViewListener() {
            ...
            public void onVolumeChange(MediaView mediaView, float volume) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: Volume " + volume);
            }

            @Override
            public void onPause(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: Paused");
            }

            @Override
            public void onPlay(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: Play");
            }

            @Override
            public void onFullscreenBackground(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: FullscreenBackground");
            }

            @Override
            public void onFullscreenForeground(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: FullscreenForeground");
            }

            @Override
            public void onExitFullscreen(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: ExitFullscreen");
            }

            @Override
            public void onEnterFullscreen(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: EnterFullscreen");
            }

            @Override
            public void onComplete(MediaView mediaView) {
                Log.e(inatboxtvapkindir7_splesh.class.toString(), "MediaViewEvent: Completed");
            }
        });
